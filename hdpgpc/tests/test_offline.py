...
#Select the lead of the data to work with or both in the offline case
lead = 0
data = data[:,:,[lead]]
...
sw_gp = hdpgp.GPI_HDP(x_basis, x_basis_warp=x_basis_warp, n_outputs=num_outputs, kernels=None, model_type='dynamic',
                          ...
                          bayesian_params=True, inducing_points=False)
...
plot_models(sw_gp, selected_gpmodels, main_model, labels, 0, lead=lead, save=out+"Offline_Clusters.html",
